...
htmlhelp_basename = 'ThreatIngestordoc'
...
latex_documents = [
    (master_doc, 'ThreatIngestor.tex', u'ThreatIngestor Documentation',
...
man_pages = [
    (master_doc, 'ThreatIngestor', u'ThreatIngestor Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ThreatIngestor', u'ThreatIngestor Documentation',
     author, 'ThreatIngestor', 'Extract and aggregate IOCs from threat feeds.',
     'Miscellaneous'),
]
