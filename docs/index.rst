...
information like :term:`C2` IPs/domains and YARA signatures, and send that
information to other systems for analysis.

Use ThreatIngestor alongside ThreatKB_ or MISP_ to automate importing public
C2s and YARA signatures, or integrate it into your existing workflow with
:ref:`custom operator plugins <custom-operator-plugins>`.
