...
class TestArtifacts(unittest.TestCase):
    ...
    def test_url_deobfuscation(self):
        self.assertEquals(threatingestor.artifacts.URL('http://example.com/', '').deobfuscated(), 'http://example.com/')
        self.assertEquals(threatingestor.artifacts.URL('http://example[.]com/', '').deobfuscated(), 'http://example.com/')
        self.assertEquals(threatingestor.artifacts.URL('http://example(.)com/', '').deobfuscated(), 'http://example.com/')
        self.assertEquals(threatingestor.artifacts.URL('http://example[.]com/[.]', '').deobfuscated(), 'http://example.com/[.]')
        self.assertEquals(threatingestor.artifacts.URL('hxxp://example[.]com/', '').deobfuscated(), 'http://example.com/')
        self.assertEquals(threatingestor.artifacts.URL('tcp://example[.]com/', '').deobfuscated(), 'http://example.com/')
        self.assertEquals(threatingestor.artifacts.URL('example[.]com/', '').deobfuscated(), 'http://example.com/')
        self.assertEquals(threatingestor.artifacts.URL('hxxp://example[dot]com/', '').deobfuscated(), 'http://example.com/')
        self.assertEquals(threatingestor.artifacts.URL('example[dot]com', '').deobfuscated(), 'http://example.com')
        self.assertEquals(threatingestor.artifacts.URL('192[.]168[dot]0[.]1', '').deobfuscated(), 'http://192.168.0.1')
        self.assertEquals(threatingestor.artifacts.URL('http://example[.com/', '').deobfuscated(), 'http://example.com/')
        self.assertEquals(threatingestor.artifacts.URL('http://example.com/ test', '').deobfuscated(), 'http://example.com/ test')
        self.assertEquals(threatingestor.artifacts.URL('http://[fdc4:2581:575b:5a72:0000:0000:0000:0001]:80/path', '').deobfuscated(),
                                        'http://[fdc4:2581:575b:5a72:0000:0000:0000:0001]:80/path')
        self.assertEquals(threatingestor.artifacts.URL('http://example.com[/]test', '').deobfuscated(), 'http://example.com/test')
        self.assertEquals(threatingestor.artifacts.URL('http://[example.com', '').deobfuscated(), 'http://example.com')
        self.assertEquals(threatingestor.artifacts.URL(u'http://example\u30fbcom', '').deobfuscated(), 'http://example.com')
        self.assertEquals(threatingestor.artifacts.URL('http://192,168,0,1', '').deobfuscated(), 'http://192.168.0.1')
        self.assertEquals(threatingestor.artifacts.URL('http://example,com/', '').deobfuscated(), 'http://example.com/')
    ...
    def test_url_domain_parsing(self):
        self.assertEquals(threatingestor.artifacts.URL('http://example.com/', '').domain(), 'example.com')
        self.assertEquals(threatingestor.artifacts.URL('http://example[.]com/', '').domain(), 'example.com')
        self.assertEquals(threatingestor.artifacts.URL('http://example[.]com/[.].com', '').domain(), 'example.com')
        self.assertEquals(threatingestor.artifacts.URL('tcp://example[.]com:80/', '').domain(), 'example.com')
        self.assertEquals(threatingestor.artifacts.URL('example[.]com/', '').domain(), 'example.com')

    def test_ipaddress_parsing(self):
        # str
        self.assertEquals(str(threatingestor.artifacts.IPAddress('192[.]168[.]0[.]1', '')), '192.168.0.1')
        self.assertEquals(str(threatingestor.artifacts.IPAddress('192.168.0.1/some/url', '')), '192.168.0.1')
        self.assertEquals(str(threatingestor.artifacts.IPAddress('192.168.0.1:9090', '')), '192.168.0.1')
        self.assertEquals(str(threatingestor.artifacts.IPAddress('192.168.0.1:9090/url', '')), '192.168.0.1')
        self.assertEquals(str(threatingestor.artifacts.IPAddress('192[.]168[.]0[.]1:9090/url', '')), '192.168.0.1')
        self.assertNotEquals(str(threatingestor.artifacts.IPAddress('192[.]188[dot]0[.]1:9090/url', '')), '192.168.0.1')
        # ipaddress
        self.assertEquals(threatingestor.artifacts.IPAddress('192[.]168[.]0[.]1', '').ipaddress(), ipaddress.IPv4Address(u'192.168.0.1'))
        self.assertEquals(threatingestor.artifacts.IPAddress('192.168.0.1/some/url', '').ipaddress(), ipaddress.IPv4Address(u'192.168.0.1'))
        self.assertEquals(threatingestor.artifacts.IPAddress('192.168.0.1:9090', '').ipaddress(), ipaddress.IPv4Address(u'192.168.0.1'))
        self.assertEquals(threatingestor.artifacts.IPAddress('192.168.0.1:9090/url', '').ipaddress(), ipaddress.IPv4Address(u'192.168.0.1'))
        self.assertEquals(threatingestor.artifacts.IPAddress('192[.]168[.]0[.]1:9090/url', '').ipaddress(), ipaddress.IPv4Address(u'192.168.0.1'))
    ...
    def test_second_arg_to_artifact_is_source_name(self):
        self.assertEquals(threatingestor.artifacts.URL('http://t.co/', 'a').source_name, 'a')
        self.assertEquals(threatingestor.artifacts.Domain('t.co', 'a').source_name, 'a')

    def test_hash_type_is_correct(self):
        self.assertEquals(threatingestor.artifacts.Hash('68b329da9893e34099c7d8ad5cb9c940', '').hash_type(), threatingestor.artifacts.Hash.MD5)
        self.assertEquals(threatingestor.artifacts.Hash('adc83b19e793491b1c6ea0fd8b46cd9f32e592fc', '').hash_type(), threatingestor.artifacts.Hash.SHA1)
        self.assertEquals(threatingestor.artifacts.Hash('01ba4719c80b6fe911b091a7c05124b64eeece964e09c058ef8f9805daca546b', '').hash_type(),
