...
class TestOperators(unittest.TestCase):
    ...
    def test_process_includes_artifact_iff_source_name_is_allowed_or_allowed_is_empty(self):
        ...
        artifact_list = [
            artifacts.IPAddress('21.21.21.21', 'source-1'),
            artifacts.Domain('test.com', 'source-1'),
            artifacts.URL('http://example.com', 'source-2'),
            artifacts.Domain('example.com', 'source-3'),
        ]
    ...
    def test_regex_allowed_sources(self):
        operators.Operator.handle_artifact = lambda x, y: x.artifacts.append(y)
        operator = operators.Operator(allowed_sources=['source-.*'])
        operator.artifact_types = [artifacts.Domain, artifacts.IPAddress, artifacts.URL]
        operator.artifacts = []
        ...
        artifact_list = [
            ...
            artifacts.Domain('test.com', 'source-1'),
            artifacts.URL('http://example.com', 'source-2'),
            artifacts.Domain('example.com', 'test-3'),
        ]
